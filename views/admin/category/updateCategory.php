...
<h1 class="py-4 fw-bold" style="font-weight: bold; padding: 0 30px; font-size: 30px;">Update Category</h1>
...
<?php $form = \app\core\form\Form::begin('', 'post') ?>
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="id_category" value="<?php echo $result->category_id ?? '' ?>" disabled>
        <div id="emailHelp" class="form-text">Tạo loại sản phẩm mới.</div>
    </div>
    <div class="mb-3">
        <?php echo $form->fieldUpdate($model, 'name', $result) ?>
    </div>
    ...
    <div class="">
        ...
        <button type="button" class="btn btn-outline-primary mx-2">Nhập lại</button>
