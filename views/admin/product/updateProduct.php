...
<div class="pcoded-content bg-white mt-4 px-4">
    <h1 class="pt-4 fw-bold" style="font-weight: bold; padding: 0 30px; font-size: 30px;">Update Product</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body img-block text-center">
                                <div style="width: 150px; height: 150px; border: 3px solid #ffffff; box-shadow: 0 0.5rem 1.5rem 0.5rem rgba(0, 0, 0, 0.075);" class="">
                                    <img id="imagePreview" src="<?php echo $result->product_image ?>" alt="avatar" class="img-fluid" style="max-width: 150px; height: 100% ;border-radius: .475rem; background-repeat: no-repeat; background-size: cover;">
                                </div>
                                <div class="pt-4">
                            ...
                            <div class="card-body d-flex flex-column text-start">
                                ...
                                <select name="category_category_id" style="width: 100%; padding:0.5rem 1rem; border-radius: 6px;" class="form-select-cate form-select-solid select2-hidden-accessible" data-control="select2" data-hide-search="true">
                                    ...
                                    foreach ($category as $key => $value) {
                                        extract($value);
                                    ?>
                                    <?php if ($result->category_category_id === $value['category_id']) {
                                            ?>
                                                <option selected value="<?php echo $category_id ?>">
                                                    <?php echo $name ?>
                                                </option>
                                            <?php
                                        } else {
                    ...
                    <div class="col-lg-8">
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php echo $form->fieldUpdate($model, 'product_name', $result) ?>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php echo $form->fieldUpdate($model, 'price', $result) ?>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-12">
                                        <?php echo $form->fieldUpdate($model, 'description', $result) ?>
                                    </div>
                                </div>
                                <hr>
